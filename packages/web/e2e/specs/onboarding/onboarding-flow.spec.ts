...
test.describe('Onboarding flow (authenticated)', () => {
  ...
  test('onboarding Why screen loads, then intention screen', async ({ page }) => {
    await page.goto('/onboarding', { waitUntil: 'load', timeout: 15000 });
  ...
  test('onboarding voice step loads', async ({ page }) => {
    await page.goto('/onboarding/voice?intention=confidence', { waitUntil: 'load', timeout: 15000 });
    await expect(page.locator('main, [role="main"]').first()).toBeVisible({ timeout: 10000 });
  ...
  test('onboarding profile step loads', async ({ page }) => {
    await page.goto('/onboarding/profile', { waitUntil: 'load', timeout: 15000 });
    await expect(page.locator('main, [role="main"]').first()).toBeVisible({ timeout: 10000 });
  ...
  test('onboarding preferences redirects to guide', async ({ page }) => {
    await page.goto('/onboarding/preferences', { waitUntil: 'load', timeout: 15000 });
  ...
  test('onboarding guide step loads with content type cards', async ({ page }) => {
    await page.goto('/onboarding/guide', { waitUntil: 'load', timeout: 15000 });
    await expect(page.locator('main, [role="main"]').first()).toBeVisible({ timeout: 10000 });
