...
export const APP_ROUTES: RouteEntry[] = [
  ...
  { path: '/system/pipelines', section: 'Superadmin', description: 'Pipelines reference (scientific foundations)', status: 'exists', note: 'Superadmin only' },
  { path: '/system/audio', section: 'Superadmin', description: 'Audio & TTS reference', status: 'exists', note: 'Superadmin only' },
  { path: '/system/conversation', section: 'Superadmin', description: 'Conversation flow (LLM state machine)', status: 'exists', note: 'Superadmin only' },
  { path: '/system/schema', section: 'Superadmin', description: 'Schema live status', status: 'exists', note: 'Superadmin only' },
  { path: '/admin/content', section: 'Superadmin', description: 'Content overview (counts, activity)', status: 'exists', note: 'Superadmin only' },
