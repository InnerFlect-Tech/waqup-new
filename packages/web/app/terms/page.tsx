...
export default function TermsPage() {
  const { entityName, contactEmail, lastUpdated, termsEffectiveDate } =
    LEGAL_CONFIG;
    ...
    <PageShell intensity="medium">
      <PageContent style={{ maxWidth: 680 }}>
        ...
        <LegalSection title="2. Wellness Disclaimer — Important">
          <p style={{ fontWeight: 600, color: 'rgba(255,255,255,0.95)' }}>
        ...
        <LegalSection title="4. Account and Security">
          <p>
            ...
            your account. Notify us immediately at {contactEmail} if you
        ...
        <LegalSection title="5. Subscriptions and Payments">
          ...
          <p>
            ...
            at {contactEmail} with your order details to request a refund.
        ...
        <LegalSection title="11. Dispute Resolution">
          <p>
            ...
            fails, disputes may be resolved through binding arbitration or in
            the courts of our jurisdiction, as applicable.
          </p>
        </LegalSection>
