...
**Reference**: [07-design-system.md](../04-reference/07-design-system.md) for token definitions.
...
| AudioWaveform.tsx | gap: 6 | — | OK (fixed bar spacing) |
...
| `packages/web/src/components/audio/AudioWaveform.tsx` | gap already uses fixed value for bar spacing |
